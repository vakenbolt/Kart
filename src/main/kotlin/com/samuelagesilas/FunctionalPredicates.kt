 ...
 */
data class PredicateFunction<T : DecisionTreeClassifierRow<*>>(val label: String,
 ...
 * [T] indicates the type associated with the classification column in the training model.
 * @param left: A [List] of [DecisionTreeClassifierRow] if the invocation result of the predicate lambda is true
 * @param right: A [List] of [DecisionTreeClassifierRow] if the invocation result of the predicate lambda is false
 */
data class PredicateResult<T>(val left: List<DecisionTreeClassifierRow<T>>,
                              val right: List<DecisionTreeClassifierRow<T>>)
 ...
 * [T] indicates the type associated with the classification column in the training model.
 */
data class Predicate<T>(val predicateFunction: PredicateFunction<DecisionTreeClassifierRow<T>>,
...
data class PredicateNode<T>(var predicate: Predicate<T>,
                            ...
                            var nodeResult: List<DecisionTreeClassifierRow<T>>?,
